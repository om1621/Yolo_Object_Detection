...
import io
import base64
from flask_restful import Resource, reqparse  # What is REST API?
...
from PIL import Image  # challenges faced during project - slug size was more than 500 mb, the deployed heroku app was too slow to render any real-time results
# different languages on the two ends are incompatible therefore needs compatibility
